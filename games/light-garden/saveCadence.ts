// When to hand the garden to ctx.storage. The storage layer debounces and the
// shell flushes on put-away; this makes sure the newest garden, including a
// piece mid-drag, is what the last save() carried.
