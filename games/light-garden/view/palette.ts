...
export const PALETTE = {
  ...
  frame: [0.2, 0.155, 0.125] as RGB,
  frameTop: [0.3, 0.24, 0.19] as RGB,
  frameSide: [0.09, 0.075, 0.065] as RGB,
  felt: [0.09, 0.2, 0.21] as RGB,
  feltSlot: [0.055, 0.13, 0.14] as RGB,
  panelCentre: [0.4, 0.49, 0.49] as RGB,
  panelEdge: [0.22, 0.3, 0.31] as RGB,
...
export const PIECE_LOOK: Readonly<Record<PieceId, GlassLook>> = {
  ...
  lampB: { tint: [0.66, 0.84, 0.8], rim: [0.93, 1, 0.98], core: [0.95, 1, 0.95] },
  prism: { tint: [0.72, 0.86, 0.9], rim: [0.97, 1, 1], core: [0.9, 0.95, 1] },
  mirror1: { tint: [0.74, 0.82, 0.86], rim: [0.98, 1, 1], core: [0.95, 0.98, 1] },
  mirror2: { tint: [0.74, 0.82, 0.86], rim: [0.98, 1, 1], core: [0.95, 0.98, 1] },
...
export const CREATURE_LOOK: Readonly<Record<CreatureKind, GlassLook>> = {
  moth: { tint: [0.95, 0.93, 1], rim: [1, 1, 1], core: [1, 0.98, 0.95] },
