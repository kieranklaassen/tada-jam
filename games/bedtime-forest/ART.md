...
- **Dusk, night, morning.** An apricot horizon under a violet sky; at night the whole forest is graded to moonlit blue, the camera tilts up to show the moon rising with its ink ring and stars coming out one by one, and each lit doorway glows warm. Morning brightens to pale gold and eases back to dusk.
...
- **The sky is one screen-space triangle** drawn at the far plane after the opaque scene, so it only paints the pixels the forest leaves uncovered: banded wash, dry-brush clouds, a far painted treeline, the moon, and hashed stars. When the camera tilts up at night the sky shifts with it.
...
- **Budget.** 19 draw calls at full quality (target under 80), one full-screen pass, zero network requests, geometry built once. The render loop stops whenever the forest is unattended or hidden.
...
- **Owl:** waddles with a level head; turns its head all the way round as its trick; hangs head-stabilised when carried with slow wing flaps; fluffs up into a ball to sleep; stretches one wing at a time on waking.
- **Fox:** trots on diagonal leg pairs with glances and ear flicks; yawns in a play-bow; pounces; paddles all four legs when carried; curls nose-to-tail to sleep; shakes itself dry after the pond.
- **Rabbit:** hops in discrete arcs with ears that follow through; sits up and sniffs; binkies; ears flop when carried; loafs to sleep; ears pop up on waking.
- **Bear:** lumbers in a heavy pace; sits to scratch; yawns arms-up; drums its belly; hangs limp and swings slowly and far when carried; wiggles stuck in a small entrance and pops back out onto its bottom; sleeps slumped belly-up.
- **Fish:** hops on its tail across the grass; blubs; puffs up to yawn; backflips; flip-flops when carried; lies on its side and flops home from a dry bed; floats asleep in the pond.
- **Songbird:** two-footed hops with jerky head turns; stretches a wing to yawn; trills; flutters when carried; sleeps as a fluffed ball with its head tucked.
...
After 3 s idle, one awake animal gets a breathing cream ring and its home's doorway glows faintly while every animal turns to look toward its own home. After 5 s a ghost hand presses that animal, lifts it, and carries it part of the way toward its home, then sets it down: one move, not the answer. Gaps of 10, 20, 40 s, at most four demonstrations per idle stretch, and any touch clears everything. On first open, one animal gives a big invitation yawn toward the child (at most three times). No guidance at night.

## Sound

All synthesized with Web Audio ([`audio.ts`](audio.ts)): each animal's voice and yawn, thuds that follow weight, a music-box chime in the animal's own note when it settles, soft snores, the physical sounds of a wrong fit (a bonk, a splash, a slide whistle, a flop), a knock for each kind of home, a moon chime at nightfall, a music-box "Twinkle Twinkle" (public domain) over a soft pad at night, and birdsong at dawn. A small procedural room reverb warms everything.
