...
- **Boundaries:** Touch only `games/frog-choir/**` (this plan lives there too) and one registry row in `docs/art-direction.md`. No dependency, harness, script, CI, or other-game changes.
